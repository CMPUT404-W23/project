# Generated by Django 4.1.7 on 2023-03-03 23:13
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('owner', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='socialDist.author')),
            ],
        ),
        migrations.CreateModel(
            name='Post',
            fields=[
                ...
                ('visibility', models.CharField(choices=[('VISIBLE', 'Public'), ('PRIVATE', 'Private')], max_length=30)),
        ...
        migrations.CreateModel(
            name='Inbox',
            fields=[
                ('inboxID', models.CharField(default='', max_length=40, primary_key=True, serialize=False)),
